                ...
                <div riot-tag={styles['wchannel']}>
                    <div ga_event="left-channel-click" className={styles.wchannel} >
                        ...
                        <ul>
                            ...
                            <li className={styles.li} > <a className={`${styles['wchannel-item']} `} href="/ch/news_hot/" target="" ga_event="channel_hot_click"> <span>热点</span> </a> </li>
                            <li > <a className={styles['wchannel-item']} href="https://live.ixigua.com" target="_blank" ga_event="channel__click"> <span>直播</span> </a> </li>
                            <li > <a className={styles['wchannel-item']} href="/ch/news_image/" target="_blank" ga_event="channel_image_click"> <span>图片</span> </a> </li>
                            <li  > <a className={styles['wchannel-item']} href="/ch/news_tech/" target="" ga_event="channel_technology_click"> <span>科技</span> </a> </li>
                            <li  > <a className={styles['wchannel-item']} href="/ch/news_entertainment/" target="" ga_event="channel_entertainment_click"> <span>娱乐</span> </a> </li>
                            <li  > <a className={styles['wchannel-item']} href="/ch/news_game/" target="" ga_event="channel_game_click"> <span>游戏</span> </a> </li>
                            <li  > <a className={styles['wchannel-item']} href="/ch/news_sports/" target="" ga_event="channel_sports_click"> <span>体育</span> </a> </li>
                            <li  > <a className={styles['wchannel-item']} href="/ch/news_car/" target="" ga_event="channel_car_click"> <span>汽车</span> </a> </li>
                            <li  > <a className={styles['wchannel-item']} href="/ch/news_finance/" target="" ga_event="channel_finance_click"> <span>财经</span> </a> </li>
                            <li  > <a className={styles['wchannel-item']} href="/ch/funny/" target="" ga_event="channel_funny_click"> <span>搞笑</span> </a> </li>
